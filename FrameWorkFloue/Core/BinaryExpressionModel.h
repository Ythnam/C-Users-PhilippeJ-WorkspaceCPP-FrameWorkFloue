...
public:	BinaryExpressionModel(core::BinaryExpression<T>* =NULL, core::Expression<T>* =NULL);
		T evaluate() const;
...
private : BinaryExpression<T>* ope;
		  Expression<T>* operand;

};

template <class T>
BinaryExpressionModel<T>::BinaryExpressionModel(BinaryExpression<T>* _ope, Expression<T>* _operand):ope(_ope),operand(_operand){
